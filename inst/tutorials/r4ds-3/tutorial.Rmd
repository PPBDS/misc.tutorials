...
<!-- FLAG: KD needs verification against actual render output. AR noted "Not true! What is 'Data codes' in the table?" — revisit after render. -->

This answers a different question than Exercise 7: average record length rather than record count. A category can have many short records (Traveling) or a few long ones (Personal Care, which includes sleep). To get total time per person per day, researchers sum `duration_min` per respondent, which Exercise 12 will do.
