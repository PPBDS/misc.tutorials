...
<!-- AR: Replace with something like: "Create a data directory in the root of your project". Check this against the guidance document. -->
...
Make a new code chunk to `analysis.qmd` and add code to connect to the database file and run `dbListTables()` to see the available tables.
